...
ggplot(data.msgs, aes(value, color=method, shape=method, linetype=method)) +
...
ggsave(paste0(basefspath, "eval/plots/etc_messages.png"), dpi=600)
print(paste0("eog ", basefspath, "eval/plots/etc_messages.png"))

ggplot(data.time, aes(y=value*1000, x=method, color=method, )) +
    geom_jitter() +
    theme_bw() +
...
ggsave(paste0(basefspath, "eval/plots/etc_time.png"), dpi=600)
print(paste0("eog ", basefspath, "eval/plots/etc_time.png"))
